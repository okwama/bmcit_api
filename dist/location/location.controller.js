...
let LocationController = class LocationController {
    ...
    async updateLocation(updateLocationDto, req) {
        return this.locationService.updateLocation(updateLocationDto.requestId, req.user.id, updateLocationDto.latitude, updateLocationDto.longitude);
    }
    async getLocationHistory(requestId, req) {
...
__decorate([
    (0, common_1.Get)('history/:requestId'),
