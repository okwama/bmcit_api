...
exports.TeamsModule = TeamsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([team_entity_1.Team, user_entity_1.User, team_member_entity_1.TeamMember])],
        controllers: [teams_controller_1.TeamsController],
        providers: [teams_service_1.TeamsService, cloudinary_service_1.CloudinaryService],
